...
/**
 * ext4_derive_key_v2() - Derive 512 bit key from 128 bit nonce and 512 bit master
 ...
 * Return: 0 on success, -errno on failure
 */
static int ext4_derive_key_v2(const u8 nonce[EXT4_KEY_DERIVATION_NONCE_SIZE],
			      const u8 master_key[EXT4_MAX_KEY_SIZE],
			      u8 derived_key[EXT4_MAX_KEY_SIZE])
{
