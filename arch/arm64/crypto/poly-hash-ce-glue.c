 ...
 * actually both "wrong" because the elements are actually in 'ble' format, and
 * there should be a ble type to represent this --- as well as lle, bbe, and lbe
 * types for the other conventions for representing GF(2^128) elements.  But
 * practically it doesn't matter which type we choose, so we just use le128 here
