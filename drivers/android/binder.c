...
static int binder_open(struct inode *nodp, struct file *filp)
{
	...
	if (proc->context->binder_debugfs_dir_entry_proc) {
		...
		proc->debugfs_entry = debugfs_create_file(strbuf, S_IRUGO,
			proc->context->binder_debugfs_dir_entry_proc,
...
static int __init init_binder_device(const char *name)
{
	...
	context->binder_debugfs_dir_entry_root = debugfs_create_dir(name, NULL);
	context->binder_debugfs_dir_entry_proc =
		debugfs_create_dir("proc",
				   context->binder_debugfs_dir_entry_root);
