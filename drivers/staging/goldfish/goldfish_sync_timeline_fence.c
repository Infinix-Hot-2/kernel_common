...
void goldfish_sync_timeline_put_internal(struct sync_timeline *obj)
{
 ...
 */
void goldfish_sync_timeline_signal_internal(struct sync_timeline *obj, unsigned int inc)
{
	unsigned long flags;
 ...
 */
struct sync_pt *goldfish_sync_pt_create_internal(struct sync_timeline *obj, int size,
				 unsigned int value)
{
	unsigned long flags;
	struct sync_pt *pt;
