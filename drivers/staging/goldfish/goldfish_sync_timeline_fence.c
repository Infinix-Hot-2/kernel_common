 ...
 * case of error.
 */
struct sync_timeline *goldfish_sync_timeline_create_internal(const char *name)
{
...
static void goldfish_sync_timeline_get_internal(struct sync_timeline *obj)
{
	kref_get(&obj->kref);
}

static void goldfish_sync_timeline_put_internal(struct sync_timeline *obj)
{
	kref_put(&obj->kref, goldfish_sync_timeline_free_internal);
}

/**
 * goldfish_sync_timeline_signal() - signal a status change on a sync_timeline
 ...
 */
static void goldfish_sync_timeline_signal_internal(struct sync_timeline *obj, unsigned int inc)
{
	unsigned long flags;
 ...
 */
static struct sync_pt *goldfish_sync_pt_create_internal(struct sync_timeline *obj, int size,
			     unsigned int value)
{
	unsigned long flags;
	struct sync_pt *pt;
...
static const char *goldfish_sync_timeline_fence_get_driver_name(struct fence *fence)
{
	return "goldfish_sw_sync";
}

static const char *goldfish_sync_timeline_fence_get_timeline_name(struct fence *fence)
{
...
static void goldfish_sync_timeline_fence_timeline_value_str(struct fence *fence,
					     char *str, int size)
{
	struct sync_timeline *parent = fence_parent(fence);
