 ...
 * case of error.
 */
struct goldfish_sync_timeline *goldfish_sync_timeline_create_internal(const char *name)
{
...
static void goldfish_sync_timeline_get_internal(struct goldfish_sync_timeline *obj)
{
	kref_get(&obj->kref);
}
 ...
 */
void goldfish_sync_timeline_signal_internal(struct goldfish_sync_timeline *obj, unsigned int inc)
{
	unsigned long flags;
 ...
 */
struct sync_pt *goldfish_sync_pt_create_internal(struct goldfish_sync_timeline *obj, int size,
				 unsigned int value)
{
	unsigned long flags;
	struct sync_pt *pt;
